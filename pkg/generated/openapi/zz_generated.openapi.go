...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetwork":         schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetwork(ref),
		"sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkList":     schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkList(ref),
		"sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkSpec":     schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkSpec(ref),
		"sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkStatus":   schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkStatus(ref),
	}
}
...
func schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetwork(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodNetwork represent a logical network on the k8s cluster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkSpec", "sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetworkStatus"},
	}
}

func schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodNetworkList contains a list of PodNetwork resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a slice of Network resources.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetwork"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "sigs.k8s.io/multi-network-api/apis/v1alpha1.PodNetwork"},
	}
}

func schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"enabled": {
						SchemaProps: spec.SchemaProps{
							Description: "Enabled is used to administratively enable/disable a PodNetwork. When set to false, PodNetwork Ready condition will be set to False. Defaults to True.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"config": {
						SchemaProps: spec.SchemaProps{
							Description: "Config specifies provider implementation specific configuration. Config cannot be configured with NamespaceSelector.",
							Ref:         ref("k8s.io/api/resource/v1beta1.DeviceConfiguration"),
						},
					},
					"deviceClassName": {
						SchemaProps: spec.SchemaProps{
							Description: "DeviceClassName specifies implementation provided class.\n\nYou need to specify oneOf: [DeviceClassName, NamespaceSelector]. Which classes are available depends on the implementation.\n\nImplementations may use this to restrict which devices may get requested by only installing classes with selectors for permitted devices. If users are free to request anything without restrictions, then implementations can create an empty DeviceClass for users to reference.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"namespaceSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "NamespaceSelector specifies labels to select namespaces in which we expect to find existing ResourceClaimTemplates named the same as this PodNetwork.\n\nYou need to specify oneOf: [DeviceClassName, NamespaceSelector].",
							Default:     map[string]interface{}{},
		...
		Dependencies: []string{
			"k8s.io/api/resource/v1beta1.DeviceConfiguration", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
	}
}

func schema_sigsk8sio_multi_network_api_apis_v1alpha1_PodNetworkStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodNetworkStatus contains the status information related to the network.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions describe the current conditions of the PodNetwork.\n\nKnown condition types are:\n\n* \"Accepted\" * \"Ready\"",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
